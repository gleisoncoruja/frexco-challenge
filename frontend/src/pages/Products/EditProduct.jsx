...
import { getProductById, updateProduct, reset } from '../../slices/productsSlice';
...
export const EditProduct = () => {
    ...
    const { product, error,loading,message } = useSelector((state) => state.products)
        ...
        {message && <Alert severity="success">{message}</Alert>} 
            <form className={styles.add_form} onSubmit={handleSubmit}>
                ...
                <span className={styles.add_img_span}>
                    <img src={ previewImage ? URL.createObjectURL(previewImage) : image ? `${uploads}/products/${image}` : noImage } alt="Imagem do produto" />    
                </span>
